 ...
 * FLAGS for decoder
 */
#define FLAC_FLAG_BLEND_OUTPUT 0U
 ...
 *
 * @param inst is the FLAC decoder that should be reset.
 * @param output_channels is the number of output channels.  Set to 0 to mirror input channels
 */
FX_EXPORT void fx_flac_output_channels(fx_flac_t* inst, uint8_t output_channels);

/**
 * Sets flags associated with FLAC decoder
 *
 * @param inst is the FLAC decoder
 * @param flag is the flag identified to modify
 * @param value is the value to be set, either 0 or 1
 */
FX_EXPORT void fx_flac_set_flag(fx_flac_t* inst, uint8_t flag, uint8_t value);
